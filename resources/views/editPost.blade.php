...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/blog/{{$post->id}}" method="POST" enctype="multipart/form-data">
            ...
            <textarea type="text" name="description" placeholder="Description" value="{{$post->description}}" class="py-20 bg-transparent block border-b-2 w-full h-60 text-xl outline-none">{{$post->description}}</textarea>
